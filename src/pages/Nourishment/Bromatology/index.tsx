  ...
  return (
    <>
      <Typography>
        ...
        <MyParagraph>
          食品化学：从化学角度和分子水平上研究食品的化学组成、结构、理化性质、营养和安全性质以及他们在生产、加工、贮存和运销的过程中的变化及其对食品品质和食品安全性影响的科学，是为改善食品品质、开发食品新资源、革新食品加工工艺和贮运技术、科学调整膳食结构、改进食品包装、加强食品质量控制及提高食品原料加工和综合利用水平奠定理论基础的学科。
        </MyParagraph>
        <MyParagraph>
